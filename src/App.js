...
const App = () => {
  ...
  const contractAddress = "0x5fcd1F4537B03A2acA4b3183e42a8a668eCd1d15";
  ...
  const wave = async () => {
    try {
      ...
      if (ethereum) {
        ...
        */
        const waveTxn = await wavePortalContract.wave(document.getElementById("input").value);
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        <div className="bio">
          I am Sayali and I work on Blockchain, Smart Contracts & Web3. 
